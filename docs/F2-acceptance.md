...
Checked items denote simulator/native SDK verification; the explicitly marked live handshake also used real Telegram delivery. See F2-verification.md for individual journeys and the verified offline-queue adjustment and remaining transport limits. Real-backend integration remains a separate gate.
